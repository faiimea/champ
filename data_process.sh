...
Device_id="1"
Reference_Image_Path="ref_cxk"
Result_Name="clip_smooth_test_human"
...
CUDA_VISIBLE_DEVICES=${Device_id} python -m scripts.data_processors.smpl.generate_smpls --reference_imgs_folder reference_imgs_set/${Reference_Image_Path} --driving_video_path driving_videos/${Video_Name} --device 0
...
CUDA_VISIBLE_DEVICES=${Device_id} python -m scripts.data_processors.smpl.smpl_transfer --reference_path reference_imgs_set/${Reference_Image_Path}/smpl_results/img.npy --driving_path driving_videos/${Video_Name} --output_folder transfer_set/${Result_Name} --figure_transfer --view_transfer
